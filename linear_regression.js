...
LinearReg.prototype.updateLineParameters = function()
{
	...
	for (var i = 0; i < this.controlPoint.length; i++)
	{
		numerator += (this.controlPoint[i].x - this.avgx)*(this.controlPoint[i].y - this.avgy);
...
/*
LinearReg.prototype.calc = function(t, p)
{
...
/*
QuadraticLinearReg.prototype.drawTick = function(t, l, p)
{
	this.calc(t, p);
